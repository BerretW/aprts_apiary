...
AddEventHandler("bees:requestMenuData", function(apiaryId)
    ...
    -- Příprava dat pro NUI (bez zbytečností)
    local nuiData = {}
...
-- PŘÍKLAD ÚPRAVY JEDNOHO EVENTU (ostatní insertQueen, harvestFrame, addHive uprav podobně):
-- Na konec eventu 'bees:applyMedicine' přidej:
-- RefreshClientMenu(_source, apiaryId)